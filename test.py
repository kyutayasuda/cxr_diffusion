...
def gen_cxr_path(prompt, file_name, folder_path):
    ...
    path = os.path.join(folder_path, f'{file_name}.png')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_folder", type=str, required=True, help="Folder to save the generated images")
    ...
    for index, row in df.iterrows():
        ...
        img_path = gen_cxr_path(prompt, file_name, args.output_folder)
